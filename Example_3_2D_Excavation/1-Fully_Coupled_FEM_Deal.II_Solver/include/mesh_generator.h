...
namespace mesh_generator_space
{
    ...
    public:
        ...
        static void generate_column_2(Triangulation<dim> &triangulation)
        {
            double width = 0.4;
            double height = 0.4;
            double total_length = height * 10;
        ...
        static void read_Plate_mesh_2(Triangulation<dim> &triangulation)
        {
            ...
            std::ifstream input_file("meshes/strip_2D_quad_002.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file
            ...
            for (const auto &face : triangulation.active_face_iterators())
                if (face->at_boundary())
                {
                    ...
                    if (std::fabs(face_center[0]) < 1e-9) // -ve X
                        face->set_boundary_id(0);
                    else if (std::fabs(face_center[0] - lx) < 1e-9) // +ve X
                        face->set_boundary_id(1);
                    else if (std::fabs(face_center[1]) < 1e-9) // -ve Y
                        face->set_boundary_id(2);
                    else if (std::fabs(face_center[1] - ly) < 1e-9) // +ve Y
                        face->set_boundary_id(3);
                }
        ...
        static void read_Plate_mesh_3(Triangulation<dim> &triangulation)
        {
            double lx = 10.0;
            double lx1 = 5.0;
            double ly = 10.0;
            ...
            std::ifstream input_file("meshes/strip_2D_quad_004.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file
        ...
        static void read_Plate_mesh_4(Triangulation<dim> &triangulation)
        {
            double lx = 10.0;
            double lx1 = 9.0;
            double ly = 10.0;
        ...
        static void read_Cuboid_mesh_2(Triangulation<dim> &triangulation)
        {
            ...
            std::ifstream input_file("meshes/column_3D_quad_002.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file
        ...
        static void read_excavation_mesh_1(Triangulation<dim> &triangulation)
        {
            double x0 = 0.0;
            double x1 = x0 + 10.0;
            double x2 = x1 + 0.25;
            ...
            std::ifstream input_file("meshes/poro_grid-2D-001_004.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file

            // Extract vertices
            std::vector<Point<dim>> vertices = triangulation.get_vertices();
            ...
            GridTools::delete_duplicated_vertices(vertices, cells, subcelldata, considered_vertices);
            triangulation.clear();
            ...
            for (const auto &face : triangulation.active_face_iterators())
                if (face->at_boundary())
                {
                    ...
                    if (std::fabs(face_center[0] - x0) < 1e-9) // x0
                        face->set_boundary_id(1);
                    else if (std::fabs(face_center[0] - x1) < 1e-9 && face_center[1] > y2) // x1
                                                                                           // else if (std::fabs(face_center[0] - x1) < 1e-9) // x1
                        face->set_boundary_id(2);
                    else if (std::fabs(face_center[0] - x2) < 1e-9 && face_center[1] > y2) // x2
                                                                                           // else if (std::fabs(face_center[0] - x2) < 1e-9) // x2
                        face->set_boundary_id(3);
                    else if (std::fabs(face_center[0] - x3) < 1e-9) // x3
                        face->set_boundary_id(4);
                    else if (std::fabs(face_center[1] - y0) < 1e-9) // y0
                        face->set_boundary_id(5);
                    else if (std::fabs(face_center[1] - y1) < 1e-9) // y1
                        face->set_boundary_id(6);
                    else if (std::fabs(face_center[1] - y2) < 1e-9) // y2
                        face->set_boundary_id(7);
                    else if (std::fabs(face_center[1] - y3) < 1e-9) // y3
        ...
        static void read_excavation_mesh_2(Triangulation<dim> &triangulation)
        {
            double x0 = 0.0;
            double x1 = x0 + 44.25;
            double x2 = x1 + 0.75;
            ...
            std::ifstream input_file("meshes/poro_grid-2D-001_007.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file
        ...
        static void read_excavation_mesh_3(Triangulation<dim> &triangulation)
        {
            double x0 = 0.0;
            double x1 = x0 + 44.0;
            double x2 = x1 + 1.00;
            ...
            std::ifstream input_file("meshes/poro_grid-2D-001_008.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file
        ...
        static void read_excavation_mesh_4(Triangulation<dim> &triangulation)
        {
            double x0 = 0.0;
            double x1 = x0 + 44.0;
            double x2 = x1 + 1.00;
            ...
            std::ifstream input_file("meshes/poro_grid-2D-001_009.msh");
            grid_in.read_msh(input_file); // Reading mesh from a Gmsh .msh file
