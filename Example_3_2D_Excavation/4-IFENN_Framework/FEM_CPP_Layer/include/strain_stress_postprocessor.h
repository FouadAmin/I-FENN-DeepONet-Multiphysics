  ...
  public:
    ...
    virtual std::vector<std::string> get_names() const override
    {
      ...
      case vectors:
        ...
        {
          for (unsigned int k = 0; k < dim; ++k)
            names.emplace_back("strain_xx,yy,00");

          for (unsigned int k = 0; k < dim; ++k)
            names.emplace_back("stress_xx,yy,00");
        ...
        {
          for (unsigned int k = 0; k < dim; ++k)
            names.emplace_back("strain_xx,yy,zz");
          for (unsigned int k = 0; k < dim; ++k)
            names.emplace_back("stress_xx,yy,zz");
          for (unsigned int k = 0; k < dim; ++k)
            names.emplace_back("strain_xy,yz,xz");
          for (unsigned int k = 0; k < dim; ++k)
            names.emplace_back("stress_xy,yz,xz");
        }
        else
        {
