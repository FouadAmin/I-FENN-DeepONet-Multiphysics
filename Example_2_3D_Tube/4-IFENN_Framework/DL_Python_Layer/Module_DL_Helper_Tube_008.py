...
def plot_true_vs_prediction_3D(true_output, predictions, coordinates_grid, history_index, description, trial_save_number, plots_save_folder):
    ...
    time_indices_to_plot = [0,1,4,9,59,69,79,89,99,100,114,109,119]
    ...
    for selected_use_slice_option in [False]:
        for i_time in time_indices_to_plot:
            ...
            for plot_option in plot_options:
                ...
                cam_offset = 1.4  # adjust how far you want to move to the right
                focal_offset = 1.4  # adjust how far you want to move the focal point
                ...
                p.subplot(0,0)
                p.add_axes(viewport=(0.0, 0.8, 0.15, 0.98),xlabel='X', ylabel='Y', zlabel='Z', color='black')
